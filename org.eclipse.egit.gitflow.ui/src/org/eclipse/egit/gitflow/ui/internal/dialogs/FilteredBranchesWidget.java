...
public class FilteredBranchesWidget {
	...
	FilteredBranchesWidget(List<Ref> nodes, String prefix) {
		this.nodes = nodes;
		this.prefix = prefix;
	}
	...
	Control create(Composite parent) {
		...
		FilteredTree tree = new FilteredTree(area, SWT.MULTI | SWT.H_SCROLL
		...
		branchesViewer.setContentProvider(new FlatBranchesListContentProvider());
