/*******************************************************************************
 * Copyright (C) 2010, Eclipse Egit Team <egit-dev@eclipse.org>
 *
 *
...
/**
 * Implementation of the {@link ICommitMessageProvider} for the integartion
 * of Mylyn's commit message templates.
 * 
 * @author Thorsten Kamann <thorsten@kamann.info>
 */
...
public class MylynCommitMessageProvider implements ICommitMessageProvider {
	...
	/**
	 * @return the currently activated task or <code>null</code> if no task
	 * is activated
	 */
