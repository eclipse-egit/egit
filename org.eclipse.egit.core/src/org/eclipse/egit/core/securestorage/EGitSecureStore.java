...
/**
 * This class wraps the Eclipse secure store.
 * It provides methods to put credentials for a given URI
 * to the secure store and to retrieve credentials for a given URI.
 */
public class EGitSecureStore {
	 ...
	 * Constructor
	 * @param preferences
	 *   the Eclipse secure store should be passed here if not in test mode
	 */
	...
	/**
	 * Puts credentials into the secure store
	 * @param uri
	 * @param credentials
	 * @throws StorageException
	 */
	public void putCredentials(URIish uri, EGitCredentials credentials) throws StorageException {
		URIish storedURI = uri.setUser(null).setPass(null);
		ISecurePreferences node = preferences.node(GIT_PATH_PREFIX
	...
	/**
	 * Retrieves credentials from the secure store
	 * @param uri
	 * @return credentials
	 * @throws StorageException
	 */
	public EGitCredentials getCredentials(URIish uri) throws StorageException {
		URIish storedURI = uri.setUser(null).setPass(null);
