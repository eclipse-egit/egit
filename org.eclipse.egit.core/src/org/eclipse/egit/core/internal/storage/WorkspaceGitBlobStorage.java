...
public class WorkspaceGitBlobStorage extends GitBlobStorage {
	 ...
	 * @param workspacePath
	 *            Workspace-relative path of the underlying object. This path is
	 *            not validated by this class, it's returned as is without
	 *            validating if the blob is reachable using this path.
	 * @param blob
	 *            Id of this object in its repository.
	 */
	public WorkspaceGitBlobStorage(Repository repository, String path,
			IPath workspacePath,
			ObjectId blob) {
