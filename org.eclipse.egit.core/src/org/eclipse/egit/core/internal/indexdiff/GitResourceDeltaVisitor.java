...
public class GitResourceDeltaVisitor implements IResourceDeltaVisitor {
	...
	private boolean gitAttributeChange = false;
	...
	/**
	 * @return <code>true</code> when the content of one of a .gitattributes
	 *         file has changed, <code>false</code> otherwise.
	 */
	public boolean getGitAttributeChanged() {
		return gitAttributeChange;
	}
}