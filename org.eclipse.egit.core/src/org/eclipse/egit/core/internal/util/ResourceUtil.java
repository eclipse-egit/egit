...
public class ResourceUtil {
	...
	/**
	 * The method splits the given resources by their repository.
	 * For each occurring repository a list is built containing the
	 * repository relative paths of the related resources.
	 * @param resources
	 * @return a map containing a list of repository relative paths for each occurring repository
	 */
