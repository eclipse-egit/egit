...
/**
 * List Stash Operation lists all extant stashes
 */
public class ListStashOperation implements IEGitOperation {
	...
	/**
	 * Construct an ListStashOperation
	 *
	 * @param resources
	 */
	public ListStashOperation(IResource[] resources) {
	...
	/**
	 * Construct a ListStashOperation
	 *
	 * @param resources
	 * @param paths
	 */
	public ListStashOperation(IResource[] resources, Set<String> paths) {
		this.resources = new IResource[resources.length];
		System.arraycopy(resources, 0, this.resources, 0, resources.length);
		schedulingRule = calcSchedulingRule();
	}
