...
/**
 * Gets the active task and combines the description and title into a branch
 * name suggestion.
 */
public class MylynBranchNameProvider implements IBranchNameProvider {
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.egit.ui.IBranchNameProvider#getBranchNameSuggestion()
	 */
