...
public class SwitchToMenuTest extends LocalRepositoryTestCase {
	...
	private void selectionWithProj1Common() {
		...
		assertStyleEquals(SWT.SEPARATOR, items[6]);
		assertTextEquals(UIText.SwitchToMenu_OtherMenuLabel, items[7]);
	}
	...
	public void selectionWithRepositoryHavingOver20Branches() throws Exception {
		...
		assertStyleEquals(SWT.SEPARATOR, items[24]);
		assertTextEquals(UIText.SwitchToMenu_OtherMenuLabel, items[25]);
	}
