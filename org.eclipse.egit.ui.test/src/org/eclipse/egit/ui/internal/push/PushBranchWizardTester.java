...
public class PushBranchWizardTester {
	...
	public void deselectConfigureUpstream() {
		wizard.checkBox(UIText.PushBranchPage_ConfigureUpstreamCheck)
				.deselect();
	}

	public void selectMerge() {
		wizard.checkBox(UIText.PushBranchPage_ConfigureUpstreamCheck).select();
		wizard.radio(UIText.PushBranchPage_MergeRadio).click();
	}

	public void selectRebase() {
		wizard.checkBox(UIText.PushBranchPage_ConfigureUpstreamCheck).select();
		wizard.radio(UIText.PushBranchPage_RebaseRadio).click();
	}
