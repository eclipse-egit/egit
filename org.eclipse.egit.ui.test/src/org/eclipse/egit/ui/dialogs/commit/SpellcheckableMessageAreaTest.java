...
import org.eclipse.egit.ui.internal.dialogs.SpellchecableMessageArea;
import org.eclipse.egit.ui.internal.dialogs.SpellchecableMessageArea.WrapEdit;
...
public class SpellcheckableMessageAreaTest {
	...
	private static String wrap(String text, String lineDelimiter) {
		...
		List<WrapEdit> wrapEdits = SpellchecableMessageArea.calculateWrapEdits(text, 70,
				lineDelimiter);
