...
public class SynchronizeViewRemoteAwareChangeSetModelTest
	...
	protected void createMockLogicalRepository() throws Exception {
		...
		IFile[] committables = new IFile[] { mockLogicalFile, file1, file2 };
		List<IFile> untracked = new ArrayList<>();
		untracked.addAll(Arrays.asList(committables));
		CommitOperation op = new CommitOperation(committables, untracked,
		...
		file3.create(
				...
				false, null);
		committables = new IFile[] { mockLogicalFile, file1, file2, file3 };
		untracked = new ArrayList<>();
		untracked.add(file3);
		op = new CommitOperation(committables, untracked, TestUtil.TESTAUTHOR,
