...
public class GitRepositoriesViewTestUtils {
	...
	public static RepositoryTreeNodeLabelProvider createLabelProvider() {
		final AtomicReference<RepositoryTreeNodeLabelProvider> providerRef = new AtomicReference<RepositoryTreeNodeLabelProvider>();
	...
	public SWTBotTreeItem getLocalBranchesItem(SWTBotTree tree, File repo)
		...
		String branchesText = labelProvider.getStyledText(branches).getString();
		String localText = labelProvider.getStyledText(localBranches)
				.getString();
	...
	public SWTBotTreeItem getTagsItem(SWTBotTree tree, File repo)
		...
		String rootText = labelProvider.getStyledText(root).getString();
		String tagsText = labelProvider.getStyledText(tags).getString();
	...
	public SWTBotTreeItem getRemoteBranchesItem(SWTBotTree tree,
		...
		String rootText = labelProvider.getStyledText(root).getString();
		String branchesText = labelProvider.getStyledText(branches).getString();
		String remoteText = labelProvider.getStyledText(remoteBranches)
				.getString();
	...
	public SWTBotTreeItem getWorkdirItem(SWTBotTree tree, File repositoryFile)
		...
		String rootText = labelProvider.getStyledText(root).getString();
		String workDirText = labelProvider.getStyledText(workdir).getString();
	...
	public SWTBotTreeItem getRemotesItem(SWTBotTree tree, File repositoryFile)
		...
		String rootText = labelProvider.getStyledText(root).getString();
		String remotesText = labelProvider.getStyledText(remotes).getString();
