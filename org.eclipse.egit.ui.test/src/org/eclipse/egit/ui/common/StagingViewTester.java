...
public class StagingViewTester {
	...
	/**
	 * Click the refresh button in the staging view
	 *
	...
	public void clickRefreshButton() throws InterruptedException {
		...
		JobJoiner jobJoiner = JobJoiner.startListening(
				org.eclipse.egit.core.JobFamilies.INDEX_DIFF_CACHE_UPDATE, 10,
				TimeUnit.SECONDS);
		stagingView.bot().tree(0).pressShortcut(0, SWT.F5, (char) 0);
		jobJoiner.join();
	}
}
