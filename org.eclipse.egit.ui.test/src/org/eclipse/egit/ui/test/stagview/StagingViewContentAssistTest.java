...
/**
 * Content assist of the Staging view commit message area must survive a
 * perspective switch (bug 536645). e4 fires {@code SWT.Deactivate} on the
 * still-focused widget when it parks a hidden part off-screen; without the
 * {@code ActionUtils} guard the handler stays deregistered afterwards.
 * <p>
 * The spurious {@code SWT.Deactivate} is platform specific (notably Windows);
 * elsewhere these tests pass without exercising the regression.
 */
