...
/**
 * This is a copy on org.eclipse.jface.windows.ToolTip. Its sole purpose is to
 * get rid of the artifical inset of 5 pixels when checking for SWT.MouseExit in
 * the TooltipHideListener. That inset prevents hovering over a tooltip on GTK
 * since the tooltip gets a SWT.MouseExit event early on with coordinates inside
 * the tooltip, but not within that smaller inner area.
 *
 * TODO: Remove this class and replace by org.eclipse.jface.windows.ToolTips
 * once the problem is resolved there.
 */
