...
public class StagingViewLabelProvider extends ColumnLabelProvider {
	...
	public String getText(Object element) {
		...
		} else if (stagingEntry.isSubmodule()) {
			// Submodule entries are hoisted to the top of the section in
			// tree mode; keep their full repo-relative path visible so the
			// path context (e.g. libs/foo) is not lost.
			label.append(stagingEntry.getPath());
		} else {
