...
import static org.eclipse.egit.core.internal.Utils.validateRefName;
	...
	public static IInputValidator getRefNameInputValidator(
		...
		return new IInputValidator() {
			...
			public String isValid(String newText) {
				IStatus validationStatus = validateRefName(newText, repo,
						refPrefix, errorOnEmptyName);
				if (validationStatus.isOK()) {
					return null;
				}
				if (validationStatus.getException() != null) {
					Activator.logError(validationStatus.getMessage(),
							validationStatus.getException());
				}
