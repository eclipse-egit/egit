...
public class DiffEditorStickyLinesProvider implements IStickyLinesProvider {
	 ...
	 *
	 * Sticky line for diffs with contenttype-specific line background color.
	 */
	static class DiffStickyLine extends StickyLine {

		private String contentType;

		private DiffStickyLine(int lineNumber, DiffViewer sourceViewer,
				String contentType) {
			super(lineNumber, sourceViewer);
			this.contentType = contentType;
		}

		/* @Override since Eclipse Platform 2026-06? */
