...
public class CommitEditor extends SharedHeaderFormEditor implements
	...
	public ShowInContext getShowInContext() {
		...
		IShowInSource showInSource = Adapters.adapt(currentPage, IShowInSource.class);
	...
	public String[] getShowInTargetIds() {
		IFormPage currentPage = getActivePageInstance();
		IShowInTargetList targetList = Adapters.adapt(currentPage, IShowInTargetList.class);
		if (targetList != null) {
