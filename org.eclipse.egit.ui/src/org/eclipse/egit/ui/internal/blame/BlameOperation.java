...
public class BlameOperation implements IEGitOperation {
	...
	private void openEditor(final RevisionInformation info) {
		...
		IVerticalRulerInfo rulerInfo = Adapters.adapt(editor, IVerticalRulerInfo.class);
		...
		IRevisionRulerColumn revisionRuler = Adapters.adapt(editor, IRevisionRulerColumn.class);
