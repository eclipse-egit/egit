 ...
 * <p>
 * TODO add selectAll/unselectAll?
 * <p>
...
public class GitShareProjectsPage extends WizardPage {
	...
	public GitShareProjectsPage() {
		...
		setTitle("Share projects with GIT");
	...
	public void createControl(Composite parent) {
		...
		tv.setLabelProvider(new ITableLabelProvider() {
			...
			public String getColumnText(Object element, int columnIndex) {
				...
				case 1:
					String repo = getRepository((IProject) element);
					if (repo == null)
	...
	private void checkPage() {
		...
		try {
			...
			if (projects == null || projects.length == 0) {
				setErrorMessage("No new projects found");
				return;
			}
			...
			for (Object obj : selected) {
				...
				if (getRepository(prj) == null) {
					setErrorMessage(NLS.bind(
							"No Git repository for project {0}", prj.getName()));
					return;
				}
				if (RepositoryProvider.getProvider(prj) != null)
					setErrorMessage(NLS.bind("Project {0} already shared", prj
							.getName()));
			}
