 ...
 */
public class AsynchronousRefContentProposalCandidateProvider
	...
	/**
	 * Creates a new {@link AsynchronousRefContentProposalCandidateProvider}.
	 * Because this is supposed to run truly asynchronously, typically in a
	 ...
	 *            the upstream refs
	 */
	public AsynchronousRefContentProposalCandidateProvider(
			...
			if (!list.isFinished()) {
				IRunnableWithProgress operation = monitor -> {
					monitor.beginTask(MessageFormat.format(
							UIText.AsynchronousRefContentProposalCandidateProvider_FetchingRemoteRefsMessage,
					...
					Job showProposals = new WorkbenchJob(
							UIText.AsynchronousRefContentProposalCandidateProvider_ShowingProposalsJobName) {
