...
public class BranchConfigurationDialog extends TitleAreaDialog {
	...
	public BranchConfigurationDialog(Shell shell, String branchName,
		...
		myTitle = "Branch Configuration"; // TODO //$NON-NLS-1$
	...
	protected Control createDialogArea(Composite parent) {
		...
		branchLabel.setText("Upstream &Branch:"); //$NON-NLS-1$ // TODO
		...
		try {
			...
			Activator.logError("Exception getting Refs", e); //$NON-NLS-1$
		}

		Label remoteLabel = new Label(main, SWT.NONE);
		remoteLabel.setText("Rem&ote:"); //$NON-NLS-1$ // TODO
		...
		rebase.setText("&Rebase"); //$NON-NLS-1$ // TODO
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Git Branch Configuration"); //$NON-NLS-1$ // TODO
	}
	...
	public void create() {
		...
		setTitle(myTitle);
		setMessage(NLS.bind(
				"Edit the Upstram configuration for Branch {0}", myBranchName)); //$NON-NLS-1$ // TODO
	}
		...
		try {
			...
			try {
				...
				Activator.handleError(
						"Could not save Branch Configuration", e, true); //$NON-NLS-1$ // TODO
			}
