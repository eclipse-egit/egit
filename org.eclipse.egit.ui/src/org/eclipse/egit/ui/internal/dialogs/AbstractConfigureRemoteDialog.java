...
public abstract class AbstractConfigureRemoteDialog
	...
	/** A {@link IAction} that allows changing the common URI. */
	protected IAction changeCommonUriAction;

	/** A {@link IAction} that allows deleting the common URI. */
	protected IAction deleteCommonUriAction;

	/**
	 * A {@link IAction} to add a new {@link RefSpec} to the
	 * {@link #specViewer}.
	 */
	protected IAction addRefSpecAction;

	/**
	 * A {@link IAction} to change an existing {@link RefSpec} in the
	 * {@link #specViewer}.
	 */
	protected IAction changeRefSpecAction;

	/**
	 * A {@link IAction} opening an advanced {@link RefSpec} dialog.
	 */
