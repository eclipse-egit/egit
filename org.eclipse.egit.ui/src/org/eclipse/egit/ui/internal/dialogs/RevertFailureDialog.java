...
public class RevertFailureDialog extends MessageDialog {
	...
	protected Control createCustomArea(Composite parent) {
		...
		new Label(fileArea, SWT.NONE)
				.setText(UIText.RevertFailureDialog_LabelFiles);

		GridDataFactory.fillDefaults().grab(true, true).applyTo(fileArea);
		GridLayoutFactory.swtDefaults().applyTo(fileArea);
