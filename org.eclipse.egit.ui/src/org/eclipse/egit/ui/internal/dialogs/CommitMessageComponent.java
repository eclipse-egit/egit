...
public class CommitMessageComponent {
	...
	private int caretPosition = CommitMessageWithCaretPosition.DEFAULT_POSITION;

	private String commitMessageBeforeAmending = EMPTY_STRING;

	private int carePositionBeforeAmending = CommitMessageWithCaretPosition.DEFAULT_POSITION;

	private String previousCommitMessage = EMPTY_STRING;

	private int previousCaretPosition = CommitMessageWithCaretPosition.DEFAULT_POSITION;
	...
	public void resetState() {
		...
		commitMessage = null;
		caretPosition = CommitMessageWithCaretPosition.DEFAULT_POSITION;
		commitMessageBeforeAmending = EMPTY_STRING;
		carePositionBeforeAmending = CommitMessageWithCaretPosition.DEFAULT_POSITION;
		previousCommitMessage = EMPTY_STRING;
		previousCaretPosition = CommitMessageWithCaretPosition.DEFAULT_POSITION;
		author = null;
		previousAuthor = null;
		committer = null;
		signedOff = false;
