...
public class CommitMessageComponent {
	...
	private CommitMessageCalculator commitMessageCalculator;
	...
	public void updateUI() {
		...
		commitMessageCalculator = new CommitMessageCalculator(repository,
				filesToCommit);
	...
	String calculateCommitMessage(Collection<String> paths) {
		...
		return commitMessageCalculator.calculateCommitMessage();
	}
