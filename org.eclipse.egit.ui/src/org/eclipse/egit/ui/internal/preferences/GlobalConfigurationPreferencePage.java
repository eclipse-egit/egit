...
public class GlobalConfigurationPreferencePage extends PreferencePage implements
	...
	protected Control createContents(Composite parent) {
		...
		value
				.setText(UIText.GlobalConfigurationPreferencePage_ValueColumnHeader);
		value.setWidth(250);
		...
		new Label(valuePanel, SWT.NONE).setText(UIText.GlobalConfigurationPreferencePage_ValueLabel);
		...
		remove
				.setText(UIText.GlobalConfigurationPreferencePage_RemoveAllButton);
		remove
				.setToolTipText(UIText.GlobalConfigurationPreferencePage_RemoveAllTooltip);
