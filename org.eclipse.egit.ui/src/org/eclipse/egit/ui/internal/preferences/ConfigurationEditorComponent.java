...
public class ConfigurationEditorComponent {
	...
	public Control createContents() {
		...
		value
				.setText(UIText.ConfigurationEditorComponent_ValueColumnHeader);
		value.setWidth(250);
		...
		tv.setLabelProvider(new LabelProvider(defaultFont));
		...
		applyValue
				.setText(UIText.ConfigurationEditorComponent_ChangeButton);
		...
		removeValue
				.setText(UIText.ConfigurationEditorComponent_RemoveButton);
		...
		newEntry
				.setText(UIText.ConfigurationEditorComponent_NewValueButton);
		...
		remove
				.setText(UIText.ConfigurationEditorComponent_RemoveAllButton);
		remove
	...
	private static final class LabelProvider extends BaseLabelProvider
		...
		public LabelProvider(Font defaultFont) {
