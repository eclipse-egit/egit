	...
	protected void createFieldEditors() {
		...
		warnCheckbox.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				handleCheckboxSelection(warnCheckbox.getSelection(), warnCombo,
						buildProblemsGroup);
			}
		});
		...
		blockCheckbox.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				handleCheckboxSelection(blockCheckbox.getSelection(),
						blockCombo, buildProblemsGroup);
			}
		});
		...
		handleCheckboxSelection(warnCheckbox.getSelection(), warnCombo,
				buildProblemsGroup);
		handleCheckboxSelection(blockCheckbox.getSelection(), blockCombo,
				buildProblemsGroup);
