 ...
 */
public class ShowAnnotationActionHandler extends RepositoryActionHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (selected.length == 1 && selected[0] instanceof IFile)
			JobUtil.scheduleUserJob(new AnnotateOperation((IFile) selected[0],
					HandlerUtil.getActiveShell(event), HandlerUtil
