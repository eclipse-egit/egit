...
public class ActionCommands {
	...
	public static final String CREATE_STASH = "org.eclipse.egit.ui.team.CreateStash"; //$NON-NLS-1$

	/** "List stash" action command id */
	public static final String LIST_STASH = "org.eclipse.egit.ui.team.ListStash"; //$NON-NLS-1$
