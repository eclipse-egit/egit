...
import org.eclipse.egit.core.op.ListStashOperation;
 ...
 *
 * @see ListStashActionHandler
 */
public class ListStashActionHandler extends RepositoryActionHandler {
	/**
	 *
	 */
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		ListStashOperation op = new ListStashOperation(resources);

		// run clean job
		JobUtil.scheduleUserJob(op, "List Stash", //$NON-NLS-1$
