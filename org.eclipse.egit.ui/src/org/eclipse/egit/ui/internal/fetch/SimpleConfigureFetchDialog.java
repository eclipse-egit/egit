...
public class SimpleConfigureFetchDialog extends TitleAreaDialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		repositoryGroup.setLayout(new GridLayout(1, false));
		...
		addDefaultOriginWarningIfNeeded(repositoryGroup);

		final Composite sameUriDetails = new Composite(repositoryGroup,
				SWT.NONE);
		...
		final Group refSpecGroup = new Group(repositoryGroup,
