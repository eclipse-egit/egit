...
class FilterCache {
	...
	private FilterCache() {
		// Load in the background. Use a daemon thread since this instantiation
		// may occur very early; the JobManager may perhaps even be still
		// suspended.
		loader = new Thread(this::loadFromPreferences);
