...
public class BranchPropertySource implements IPropertySource {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		PropertyDescriptor desc = new PropertyDescriptor(
				ConfigConstants.CONFIG_KEY_MERGE, "Upstream Branch"); //$NON-NLS-1$ // TODO
		desc.setCategory("Upstream Configuration"); //$NON-NLS-1$ // TODO
		resultList.add(desc);
		desc = new PropertyDescriptor(ConfigConstants.CONFIG_KEY_REMOTE,
				"Remote"); //$NON-NLS-1$ // TODO
		desc.setCategory("Upstream Configuration"); //$NON-NLS-1$ // TODO
		resultList.add(desc);
		desc = new PropertyDescriptor(ConfigConstants.CONFIG_KEY_REBASE,
				"Rebase"); //$NON-NLS-1$ // TODO
		desc.setCategory("Upstream Configuration"); //$NON-NLS-1$ // TODO
		resultList.add(desc);
