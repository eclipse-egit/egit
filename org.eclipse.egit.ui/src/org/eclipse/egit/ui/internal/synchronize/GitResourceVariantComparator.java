...
class GitResourceVariantComparator implements IResourceVariantComparator {
	...
	public GitResourceVariantComparator(GitSynchronizeDataSet data, ResourceVariantByteStore store) {
		gsd= data;
		this.store = store;
	}
	...
	protected InputStream getLocal(IResource resource) throws CoreException {
