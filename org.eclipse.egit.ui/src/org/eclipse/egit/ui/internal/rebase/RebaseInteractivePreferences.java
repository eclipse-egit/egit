...
public class RebaseInteractivePreferences {
	...
	/**
	 * @return if change set display order is set to reversed (historical
	 *         order).
	 */
	...
	/**
	 * Sets change set display order.
	 *
	 * @param reversed
	 *            false - display change sets in the executions order, false -
	 *            display change sets in the historical order.
	 */
