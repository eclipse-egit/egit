...
public class UIText extends NLS {
	...
	/** */
	public static String CommitValidationResultDialog_CopyMessageText;

	/** */
	public static String CommitValidationResultDialog_CopyMessageTitle;
	...
	/** */
	public static String CommitValidationResultDialog_Undo;
