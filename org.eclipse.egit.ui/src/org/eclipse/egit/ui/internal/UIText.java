...
public class UIText extends NLS {
	...
	/** */
	public static String AsynchronousRefContentProposalCandidateProvider_FetchingRemoteRefsMessage;

	/** */
	public static String AsynchronousRefContentProposalCandidateProvider_ShowingProposalsJobName;
