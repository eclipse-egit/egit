...
public class UIText extends NLS {
	...
	/** */
	public static String TagPropertySource_CommitCategory;

	/** */
	public static String TagPropertySource_CommitId;

	/** */
	public static String TagPropertySource_CommitMessage;

	/** */
	public static String TagPropertySource_LightweightTagCategory;
	...
	/** */
	public static String TagPropertySource_TagObjectId;

	/** */
	public static String TagPropertySource_TagObjectType;
