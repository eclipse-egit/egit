...
/**
 * A global cache some state of repositories. The cache is automatically cleared
 * whenever the workbench selection or the menu selection changes.
 * <p>
...
public class RepositoryStateCache {
	...
	/**
	 * Retrieves the current as an {@link ObjectId}.
	 *
	 * @param repository
	 * @return ObjectId of head, or {@code null}
	 */
