...
public class PluginPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(UIPreferences.ALWAYS_SHOW_PUSH_WIZARD_ON_COMMIT, false);
		...
		store.setDefault(UIPreferences.AUTO_FETCH,
				UIPreferences.AUTO_FETCH_DISABLED);
		store.setDefault(UIPreferences.AUTO_FETCH_INTERVAL, 60);
		...
		store.setDefault(UIPreferences.STASH_APPLY_SHOW_NOTIFICATION, true);
		store.setDefault(UIPreferences.SHOW_PUSH_POPUP_SUCCESS, true);
		store.setDefault(UIPreferences.SHOW_FORK_UPSTREAM_PUSH_CONFIRMATION,
				true);
