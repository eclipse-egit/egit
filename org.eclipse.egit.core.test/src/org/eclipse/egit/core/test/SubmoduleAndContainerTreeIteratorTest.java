...
public class SubmoduleAndContainerTreeIteratorTest {
	...
	public void setUp() throws Exception {
		...
		// We have to wait after untile the filesystem timer has advanced to
	...
	public void testCleanStateAfterInit() throws NoWorkTreeException,
		...
		Status status = parentGit
				.status()
				.setWorkingTreeIt(
						new AdaptableFileTreeIterator(parentRepository
								.getRepository(), parentFile.getWorkspace()
								.getRoot())).call();
