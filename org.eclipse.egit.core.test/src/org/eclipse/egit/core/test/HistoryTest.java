...
public class HistoryTest extends GitTestCase {
	...
	public void queryFile1Contributors() {
		...
		/* The "direct" parent of branchCommit1 is masterCommit2. However, that commit did not contain file1. We thus
		 * expect the returned contributor to be masterCommit1.
		 */
